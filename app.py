...
def botResponse(user_input):
    ...
    if ss.is_startup:
        response = "Hi, I'm happy to have you here \nI have a lot to discuss about Data Science"
        ss.is_startup = False
        return response
...
st.sidebar.title("BoData")
st.title("""
BoData  
BoData is a NLP bot trainned basic Data Science questions corpus using  CNN achitecture
""")
